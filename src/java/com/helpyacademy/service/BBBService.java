...
//
    public String BigBlueButtonURL;
    private String salt;
    
    public BBBService(String BigBlueButtonURL,String salt){
        this.BigBlueButtonURL = BigBlueButtonURL;
        this.salt = salt;
    }
...
//  Note this meeting will use username for meetingID
    public String getJoinURL(String username, String meetingID, String record, String welcome, Map<String, String> metadata, String xml,int duration) {
        String base_url_create = BigBlueButtonURL + "api/create?";
        String base_url_join = BigBlueButtonURL + "api/join?";
        String welcome_param = "";
        if ((welcome != null) && !welcome.equals("")) {
